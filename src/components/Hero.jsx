  ...
  return (
    <div className="flex w-full text-white overflow-hidden">
      <div className="ml-[126px]">
        <h1 className="text-[140px] leading-[100%] font-[Pacifico,cursive]">
          icecream
        </h1>

        <h2
          className={`transition-all duration-90 transform ${
            fadeOut ? "opacity-0" : "opacity-100"
          } font-[Poppins,sans-serif] leading-[150%] text-[55px] font-semibold`}
        >
          {currentTitle}
        </h2>
        ...
        <div
          ...
          className="space-y-2 leading-[140%] font-[Poppins,sans-serif] mt-5 text-[18px]"
        >
          <p>
        ...
        <div className="flex gap-[5rem] mt-[6rem] ml-5">
          {imageArr.map(({ id, img }) => (
            <div
              className="h-[50px] w-[50px] border-2 border-white rounded-[5px] relative cursor-pointer"
            ...
            >
              <img
                ...
                src={img}
                alt=""
                className=" transition-all duration-300 ease-in-out h-[8rem] -top-8 -left-1 absolute rotate-[-10deg] hover:rotate-[10deg] hover:h-[10rem] hover:-top-15"
              />
            </div>
          ))}
        </div>
